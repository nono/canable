...
Simple permissions that I have used on my last several Rails projects so I figured it was time to abstract and wrap up into something more easily reusable.
...
You can add your own actions like this (in +config/initializers/canable.rb+ for example):
